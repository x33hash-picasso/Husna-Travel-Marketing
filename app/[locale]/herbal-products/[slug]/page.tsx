  ...
  if (!product) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center">
        ...
        <Link href="/herbal-products" className="text-emerald-medium font-bold flex items-center gap-2 hover:underline">
          ...
          <div className="flex flex-col justify-between">
            <div>
              ...
              <div className="flex items-center gap-3 text-xs uppercase font-extrabold tracking-widest mb-3">
                <span className="text-gold-dark">Natural Wellness</span>
              ...
              <div className="grid grid-cols-2 gap-4 text-xs font-semibold text-text-secondary border-t border-gray-150 py-4 mb-6">
                ...
                <div>Category Type: <span className="font-bold text-emerald-dark uppercase">Herbal</span></div>
              </div>
            </div>
