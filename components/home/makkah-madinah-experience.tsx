        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="grid grid-cols-2 gap-4 relative">
            ...
            <div className="relative h-[320px] md:h-[400px] rounded-2xl overflow-hidden shadow-lg border border-gold-medium/20 hover:-translate-y-2 transition-transform duration-500">
              <div
                ...
                style={{ backgroundImage: `url('https://images.unsplash.com/photo-1564507592333-c60657eea523?auto=format&fit=crop&w=600&q=80')` }}
              />
            ...
            <div className="relative h-[320px] md:h-[400px] rounded-2xl overflow-hidden shadow-lg border border-gold-medium/20 hover:-translate-y-2 transition-transform duration-500 mt-8 lg:mt-12">
              <div
                className="w-full h-full bg-cover bg-center"
                style={{ backgroundImage: `url('https://images.unsplash.com/photo-1591604021695-0c69b7c05981?auto=format&fit=crop&w=600&q=80')` }}
              />
              <div className="absolute inset-0 bg-gradient-to-t from-emerald-dark/60 via-transparent to-transparent" />
              <span className="absolute bottom-4 left-4 font-serif font-bold text-lg text-white">
          ...
          <div className="flex flex-col gap-6">
            <span className="text-xs uppercase font-extrabold tracking-widest text-emerald-medium bg-emerald-lighter px-3.5 py-1 rounded-full border border-emerald-light/25 w-max">
              {locale === 'ur' ? 'روحانی جذبہ' : 'Spiritual Journey'}
            </span>
            <h2 className="text-3xl md:text-5xl font-serif font-black text-emerald-dark tracking-wide leading-tight">
              {locale === 'ur'
                ? 'مقدس مقامات کی دلکش روحانی فضائیں'
                : 'A Journey of Faith and Eternal Tranquility'}
            </h2>
            <p className="text-text-secondary text-sm md:text-base leading-relaxed font-light">
              {locale === 'ur'
                ? 'ہمارا مشن آپ کو زندگی بھر کے سب سے یادگار اور مبارک سفر پر لے جانا ہے۔ مکہ مکرمہ کی پروقار فضاؤں اور مدینہ منورہ کے پرسکون گلیوں میں آپ کی آرام دہ اور پرسکون رہائش ہماری اولین ترجیح ہے۔'
                : 'Husna Travel is built upon the pillars of absolute trust and luxury hospitality. We design journeys that elevate your spiritual experience, allowing you to immerse completely in worship, reflection, and historical exploration without any earthly worries.'}
            </p>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <h4 className="font-serif font-bold text-emerald-dark text-base">
                    {locale === 'ur' ? 'سرکاری اور رجسٹرڈ کارپوریشن' : 'Fully Certified and Registered'}
                  </h4>
                  <p className="text-xs text-text-secondary font-light mt-0.5">
                    {locale === 'ur'
                      ? 'وزارت مذہبی امور پاکستان سے رجسٹرڈ اور لائسنس یافتہ سفری ایجنسی۔'
                      : 'Lincensed by the Ministry of Hajj & Umrah for complete verification and compliance.'}
                  </p>
                </div>
              </div>

              <div className="flex gap-4 items-start">
                <div className="p-3 bg-gold-lighter text-gold-dark rounded-lg border border-gold-light/20">
                  <HeartHandshake className="w-6 h-6" />
                </div>
                <div>
                  <h4 className="font-serif font-bold text-emerald-dark text-base">
                    {locale === 'ur' ? 'حقیقی مہمان نوازی اور خدمت' : 'Exceptional Pilgrim Care'}
                  </h4>
                  <p className="text-xs text-text-secondary font-light mt-0.5">
                    {locale === 'ur'
                      ? 'سفر، ویزا اور ہوٹل سے لے کر کتب اور حرمین کے تبرکات تک مکمل دیکھ بھال۔'
                      : 'From visa processing and hotels to Islamic wellness products delivered right to your doorstep.'}
                  </p>
                </div>
              </div>
            </div>
